...
@available(iOS 15.0, *)
// MARK: загрузка изображений прямо в ячейках - возможна, но наш UI будет фризиться. Ячейки переиспользуются, а что если картинка огромного размера? Или ячеек 10000 шт? Поэтому ставим им деволтную картинку или индикатор загрузки - как я сделал.А саму картику грузим в фоновой очереди - UI не морозиться, все плавно - можно не дожидаясь закрыть и перейти к другой новости. Кэшировать не обязательно - но я подумал вдруг человек между сессиями захочет снова перечитать что то или показать друзьям - ждать загрузки дважды не придется. А при закрытии приложения кэш выгрузится.
